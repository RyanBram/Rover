...
typedef struct { mu_BaseCommand base; int font_id; } mu_FontCommand;
...
struct mu_Context {
  ...
  mu_Id number_edit;
  /* textbox cursor/editing state */
  mu_Id textbox_id;       /* id of the textbox currently being edited */
  int   textbox_cursor;   /* byte offset of cursor in buf */
  int   textbox_sel;      /* byte offset of selection anchor (== cursor = no selection) */
  int   textbox_scroll_x; /* horizontal scroll in pixels (to keep cursor visible) */
  /* stacks */
