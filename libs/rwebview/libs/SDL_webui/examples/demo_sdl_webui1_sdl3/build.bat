...
set INC=-I"%BIN_DIR%\include" -I"%SRC_DIR%" -I"%WEBUI_DIR%\include" -I"%RENDERER_DIR%"
set LIB=-L"%BIN_DIR%\lib" -lSDL3
set SRCS="%SCRIPT_DIR%\main.c" "%RENDERER_DIR%\renderer_sdl3.c" "%SRC_DIR%\SDL_webui.c" "%SRC_DIR%\microui.c" "%SRC_DIR%\flex.c"
set OUT="%SCRIPT_DIR%\demo_sdl_webui1_sdl3.exe"
...
echo Building demo_sdl_webui1_sdl3 (swu_* wrapper)...
...
echo.
echo Build succeeded: demo_sdl_webui1_sdl3.exe
