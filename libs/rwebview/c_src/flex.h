...
/* Use SDL's portable export/call-convention macros so flex.h has no
 * direct dependency on Windows or any other platform ABI. */
# define DLLEXPORT      SDL_DECLSPEC
# define WINAPI_STDCALL SDLCALL
